...
TOOL = 'APIX'
TAGLINE = 'API Security Testing Toolkit'
VERSION = "3.0.0-cli"
COMMANDS = {'fuzz': {'module': 'modules.endpoint_fuzz', 'class': 'EndpointFuzzer', 'summary': 'API endpoint discovery', 'restricted': False}, 'auth': {'module': 'modules.auth_test', 'class': 'AuthTester', 'summary': 'Authentication and token checks', 'restricted': False}, 'idor': {'module': 'modules.idor_test', 'class': 'IDORTester', 'summary': 'IDOR object identifier checks', 'restricted': False}, 'ratelimit': {'module': 'modules.idor_test', 'class': 'RateLimitTester', 'summary': 'Rate limiting test', 'restricted': False}}
...
EXAMPLES = ['./apix.sh fuzz -u https://example.com', './apix.sh auth -u https://example.com', './apix.sh idor -u https://example.com']
